...
MyFrame1::MyFrame1( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxFrame( parent, id, title, pos, size, style )
{
	...
	m_staticText1 = new wxStaticText( this, wxID_ANY, _("Uklad Świata"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_staticText11 = new wxStaticText( this, wxID_ANY, _("Wartości na wykresie:"), wxDefaultPosition, wxDefaultSize, 0 );
